...
public class SigUtils {
    ...
    public static void validateTimestampToken(TimeStampToken timeStampToken, X509Certificate cert)
            throws TSPException, CertificateException, IOException, OperatorCreationException
    {
