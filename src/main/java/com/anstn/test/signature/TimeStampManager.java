...
public class TimeStampManager {
	 private TSAClient tsaClient;
	     ...
	     */
	    TimeStampManager(String tsaUrl, X509Certificate certificate) throws NoSuchAlgorithmException, MalformedURLException {
	        if (tsaUrl != null && tsaUrl != "") {
	            MessageDigest digest = MessageDigest.getInstance("SHA-256");
	            this.tsaClient = new TSAClient(new URL(tsaUrl), null, null, digest, certificate);
	        }
	    }
	    ...
	    CMSSignedData addSignedTimeStamp(CMSSignedData signedData) throws IOException, TSPException, CertificateException, OperatorCreationException, NoSuchAlgorithmException {
	        ...
	        List<SignerInformation> signersWithTimeStamp = new ArrayList<SignerInformation>();
